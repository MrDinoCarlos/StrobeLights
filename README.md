...
dependency. For Paper 26.2 use its v2 line. While a player holds the tool from
...
```text
plugins/StrobeLights/resource-pack/StrobeLights-ResourcePack-26.2.zip
```
...
For this build: `StrobeLights-0.10.23+mc.v.26.2.jar`.
