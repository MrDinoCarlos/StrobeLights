...
draw fixtures, beams or painted surfaces; throwable flashbangs and colored sky
flares deliberately emit visible vanilla effects.
...
For this build: `StrobeLights-v.0.10.10+mc.1.20.1.jar`.
