...
dependency. For Paper 1.21.10 use its v2 line. While a player holds the tool from
...
```text
plugins/StrobeLights/resource-pack/StrobeLights-ResourcePack-1.21.10.zip
```
...
For this build: `StrobeLights-v.0.10.12+mc.1.21.10.jar`.
